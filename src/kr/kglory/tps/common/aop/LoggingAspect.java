package kr.kglory.tps.common.aop;

import kr.kglory.tps.common.logging.LoggingHandler;
...
public class LoggingAspect {
     ...
     * @date 2014-08-04
     */
	@Before("execution(public * kr.kglory.tps.service..*.*(..))")
     ...
     * @date 2014-08-04
     */
//	@Around("execution(public * kr.kglory.tps.service..*.*(..))")
...
//	}
     ...
     * @date 2014-08-04
     */
//	@AfterReturning(pointcut = "execution(public * kr.kglory.tps.service..*.*(..))",  
//            returning= "result")
